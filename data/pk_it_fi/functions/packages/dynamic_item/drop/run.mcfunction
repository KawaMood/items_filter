#> pk_it_fi:packages/dynamic_item/drop/run
...
execute if data storage pk:common temp.packages.dynamic_item{apply_random_motion:1b} run function pk_it_fi:packages/dynamic_item/drop/apply_random_motion
...
# Summon item
function pk_it_fi:packages/dynamic_item/drop/summon_item with storage pk:common temp.packages.dynamic_item
