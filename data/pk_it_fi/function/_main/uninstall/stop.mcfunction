...
function pk_it_fi:_main/uninstall/references/specific

# Clear all KawaMood's data packs scores and storage if no more KawaMood's data packs are installed
execute unless data storage pk:common installed_datapacks[{}] unless data storage pk.common:data Datapacks[{}] run function pk_it_fi:_main/uninstall/references/common
