...
#       and a container with items on the reference face
execute if entity @s[tag=!pk.it_fi.items_filter.disabled,predicate=pk_it_fi:environment/filtering_items_filter] run function pk_it_fi:blocks/items_filter/behavior/filter/run