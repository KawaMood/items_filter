...
# West
execute if block ~ ~ ~1 #pk_it_fi:chest[facing=west,type=right] run return run data modify storage pk:common temp.references_untreated append from block ~ ~ ~2 Items[]
# East
execute if block ~ ~ ~1 #pk_it_fi:chest[facing=east,type=left] run return run data modify storage pk:common temp.references_untreated append from block ~ ~ ~2 Items[]
# South
