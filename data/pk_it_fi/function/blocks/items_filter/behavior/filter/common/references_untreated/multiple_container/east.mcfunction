...
# South
execute if block ~-1 ~ ~ #pk_it_fi:chest[facing=south,type=left] run return run data modify storage pk:common temp.references_untreated append from block ~-2 ~ ~ Items[]
# North
execute if block ~-1 ~ ~ #pk_it_fi:chest[facing=north,type=right] run return run data modify storage pk:common temp.references_untreated append from block ~-2 ~ ~ Items[]
# West
