...
# Offhand
$execute if items entity @s weapon.offhand player_head[custom_data~{pk_data:{id:"items_filter",from:"items_filter"}},!custom_data~{pk_data:{version:$(version)s}}] at @s summon armor_stand run function pk_it_fi:items/items_filter/update/change/slot/offhand
