#> pk_it_fi:tools/debug/recreate_all_blocks/stop
...
# Fallback
execute unless data storage pk:common debug.recreate{fallback:""} run function pk_it_fi:tools/debug/recreate_all_blocks/stop_fallback with storage pk:common debug.recreate