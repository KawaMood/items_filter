#> pk_it_fi:tools/debug/recreate_all_blocks/start
...
execute if score $pk.debug.recreate.blocks.length pk.value matches 0 run function pk_it_fi:tools/debug/recreate_all_blocks/stop
execute if score $pk.debug.recreate.blocks.length pk.value matches 1.. run function pk_it_fi:tools/debug/recreate_all_blocks/1