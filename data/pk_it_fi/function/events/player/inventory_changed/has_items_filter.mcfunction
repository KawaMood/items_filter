...
execute if items entity @s container.* player_head[custom_data~{pk_data:{id:"items_filter",from:"items_filter"}},!custom_data~{pk_data:{version:30201s}}] run function pk_it_fi:items/items_filter/update/run {version:30201s}
